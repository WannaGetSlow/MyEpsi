...
class _ProfileScreenState extends State<ProfileScreen> {
              ...
              child: Column(
                children: [
                  _buildInfoSection(
                    ...
                    [
                      _buildInfoItem(Icons.email, 'Email', email.isEmpty ? 'À renseigner' : email),
                      _buildInfoItem(Icons.phone, 'Téléphone', phone.isEmpty ? 'Non renseigné' : phone),
                      _buildInfoItem(Icons.cake, 'Date de naissance', birthDate.isEmpty ? 'Non renseigné' : birthDate),
                      _buildInfoItem(Icons.location_on, 'Adresse', address.isEmpty ? 'Non renseigné' : address),
                    ],
                  ),
                  const SizedBox(height: 15),
                  _buildInfoSection(
                    'Parcours académique',
                    [
                      _buildInfoItem(Icons.school, 'Formation actuelle', formation.isEmpty ? 'Non renseigné' : formation),
                      _buildInfoItem(Icons.calendar_today, 'Année d\'entrée', entryYear.isEmpty ? 'Non renseigné' : entryYear),
                      _buildInfoItem(Icons.work, 'Stage actuel', internship.isEmpty ? 'Non renseigné' : internship),
                    ],
                  ),
  ...
  void _showEditProfileDialog(BuildContext context) {
    ...
    final TextEditingController birthDateController = TextEditingController(text: birthDate);
    final TextEditingController addressController = TextEditingController(text: address);
    final TextEditingController formationController = TextEditingController(text: formation);
    final TextEditingController yearController = TextEditingController(text: year);
    final TextEditingController campusController = TextEditingController(text: campus);
    final TextEditingController entryYearController = TextEditingController(text: entryYear);
    final TextEditingController internshipController = TextEditingController(text: internship);
              ...
              child: Column(
                ...
                children: [
                  const Text('Informations personnelles', 
                    style: TextStyle(fontWeight: FontWeight.bold, color: Color(0xFF4A2A82))),
